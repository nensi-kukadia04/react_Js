function TodoSidebar() {
  return (
    <aside className="w-64 h-screen bg-purple-800 text-white flex flex-col fixed shadow-lg">
      {/* Profile */}
      <div className="flex flex-col items-center text-center py-8 border-b border-purple-400/40">
        <img
        ...
        <p className="text-sm text-purple-100">kukadiyanensi04@gmail.com</p>
      </div>
      ...
      <div className="mt-auto mb-6 px-6">
        <a
          href="#"
          className="flex items-center gap-3 py-3 px-4 bg-white/10 hover:bg-white/20 rounded-lg transition text-sm font-medium"
        >
          ↩️ Logout
        </a>
      </div>
