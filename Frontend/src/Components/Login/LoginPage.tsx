        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative">
                <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 transform transition-all duration-500 hover:shadow-3xl">
                    <div className="flex justify-center mb-8 animate-fade-in-down animation-delay-200">
                        <div className="bg-gradient-to-br from-blue-500 to-cyan-500 p-4 rounded-2xl shadow-lg transform transition-transform hover:scale-110 hover:rotate-3 duration-300">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="animate-fade-in-up animation-delay-300">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-4 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/50 hover:bg-white focus:bg-white"
                        ...
                        <div className="animate-fade-in-up animation-delay-400">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-12 py-3.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/50 hover:bg-white focus:bg-white"
                                    placeholder="••••••••"
                                    required
                                />
                                <button
                        ...
                        <div className="flex items-center justify-between animate-fade-in-up animation-delay-500">
                            <label className="flex items-center">
                                <input
                                    type="checkbox"
                                    className="w-4 h-4 text-blue-500 border-slate-300 rounded focus:ring-2 focus:ring-blue-500 transition-all duration-200"
                                />
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-3.5 rounded-xl font-semibold shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed animate-fade-in-up animation-delay-600 animate-glow"
                        >
                            {isLoading ? (
                    ...
                    <div className="mt-6 animate-fade-in-up animation-delay-700">
                    ...
                    <p className="mt-8 text-center text-sm text-slate-600 animate-fade-in-up animation-delay-800">
